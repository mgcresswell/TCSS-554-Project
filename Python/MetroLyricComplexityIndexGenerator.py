...
query = "SELECT MetroLyricId, ProcessedLyrics FROM MetroLyrics WHERE MetroLyricId > 13236"
...
for index, row in df.iterrows(): 
    try:
        ...
        with connection.cursor() as cursor:
           sql = "INSERT INTO MetroLyricsComplexityIndex (SongId,SentenceCount,WordCount,AvgSyllablesPerWord,AvgSentenceLength,DifficultWordCount,SyllableCount,GunningFog,PolySyllable,SmogIndex,DaleChall,Flesch) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) "   
